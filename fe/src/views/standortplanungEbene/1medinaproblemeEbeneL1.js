...
import imageMedianProblemL1 from "../../assets/image/1MedianProbleme.PNG";
/**
 * /home
 */
function MedianproblemeEbeneL1() {
    ...
    function onSubmit(data) {
        ...
        axiosInstance({
            method: 'post',
            url: 'standortplanung_ebene/medianprobleme_ebene_l1',
            data: {
                ...json_data
            }
        })
        ...
        <div className="container-fluid ">
            <div className="row ">
                <div className="col-12 mt-3">
                    <h2 className="mb-0">1-Medianprobleme mit l1-Metrik</h2>
                    <p>2D-Probleme</p>
                </div>
            </div>
            <div className="row ">
...
export default withRouter(MedianproblemeEbeneL1);